...
import com.example.desafio_tecnico.service.UserService;
...
public class UserController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<UserResponseDTO> update(@PathVariable Long id, @Valid @RequestBody UserDTO userDTO) {
